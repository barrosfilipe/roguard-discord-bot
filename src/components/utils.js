...
const mobNotFoundMessages = [
  'Não encontrei o monstro que você procura, desculpe!',
  'Esse mob tá tão mobado que eu nem achei. Foi mal!',
  'Esse monstro existe? Nem sabia, cê é louco!',
  'Olha o MONSTRO saindo da jaula!! Mentira, não achei esse!'
];

const itemNotFoundMessages = [
  'Procura na sua mochina aí pq aqui não tá!',
  'Vish... 404 item não encontrado.',
  'Quê!? Nunca vi nem comi...',
  'Esse aí é só pra quem é Zenylhonário!'
];

const frostJokerMessages = [
